...
/* ===================================================================
   5 RACES DE BASE — Humain, Nain, Elfe, Mage, Orque
   Chaque race a 2 branches d'évolution, chaque branche a 3 paliers.
   Palier 1 (niv.20) → 2 choix | Palier 2 (niv.40) → 2 choix | Palier 3 Ultime (niv.65)
   =================================================================== */
const RACES={
  humain:{n:'Humain',ico:'🧑',base:{force:6,esprit:5,vigueur:6,agilite:5,chance:5},
    trees:['physique','lumiere','feu'],passive:'+12% XP — Lignée Adaptable',pid:'xp'},
  nain:{n:'Nain',ico:'🧔',base:{force:8,esprit:3,vigueur:10,agilite:3,chance:4},
    trees:['physique','feu'],passive:'+25% PV max — Peau de Pierre',pid:'hp'},
  elfe:{n:'Elfe',ico:'🧝',base:{force:4,esprit:8,vigueur:4,agilite:9,chance:5},
    trees:['nature','givre','lumiere'],passive:'+20% esquive — Grâce Éternelle',pid:'dodge'},
  mage:{n:'Mage',ico:'🧙',base:{force:3,esprit:11,vigueur:4,agilite:5,chance:6},
    trees:['foudre','feu','givre'],passive:'+25% Mana max — Maîtrise Arcanique',pid:'mana'},
  orque:{n:'Orque',ico:'👹',base:{force:10,esprit:3,vigueur:8,agilite:5,chance:3},
    trees:['tenebres','physique','feu'],passive:'+20% dégâts physiques — Brutalité Sauvage',pid:'phys'},
};

/* Arbre d'évolution profond : 3 paliers par branche, 2 branches par race
   Branche A = Chemin du Guerrier / Branche B = Chemin du Mystique
   Palier 1 → niv.20 | Palier 2 → niv.40 | Palier 3 (Ultime) → niv.65 */
const EVOLUTION_TREE={
  humain:{
    A:[
      {key:'chevalier',n:'Chevalier',ico:'⚔️',pid:'phys',addTree:'physique',passive:'Gardien de l\'Ordre — +dégâts physiques',statBonus:{force:4,vigueur:3}},
      {key:'paladin',n:'Paladin',ico:'🛡️',pid:'hp',addTree:'lumiere',passive:'Bouclier Sacré — +PV & lumière',statBonus:{force:3,vigueur:4,esprit:2}},
      {key:'roi_sacre',n:'Roi Sacré',ico:'👑',pid:'xp',addTree:'lumiere',passive:'Commandement Divin — Toutes stats +20%',statBonus:{force:5,esprit:5,vigueur:5}},
    ],
    B:[
      {key:'barde',n:'Barde',ico:'🎵',pid:'crit',addTree:'nature',passive:'Muse de Bataille — +critique & butin',statBonus:{esprit:3,chance:4}},
      {key:'archerf',n:'Archeron',ico:'🏹',pid:'dodge',addTree:'foudre',passive:'Précision Mortelle — +critique & esquive',statBonus:{agilite:4,chance:3,esprit:2}},
      {key:'legende',n:'Légende Vivante',ico:'🌟',pid:'xp',addTree:'foudre',passive:'Héros Immortel — critique et XP maxés',statBonus:{chance:6,agilite:4,esprit:4}},
    ],
  },
  nain:{
    A:[
      {key:'gardien_nain',n:'Gardien de Pierre',ico:'🪨',pid:'hp',addTree:'physique',passive:'Forteresse Vivante — +PV massifs',statBonus:{vigueur:6,force:2}},
      {key:'seigneur_nain',n:'Seigneur des Montagnes',ico:'⛏️',pid:'hp',addTree:'feu',passive:'Cœur de Roc — +PV & résistance absolue',statBonus:{vigueur:5,force:3,agilite:-1}},
      {key:'titan_nain',n:'Titan Ancestral',ico:'🏔️',pid:'hp',addTree:'feu',passive:'Montagne Inébranlable — immunité partielle',statBonus:{vigueur:8,force:5}},
    ],
    B:[
      {key:'forgeron',n:'Forgeron de Guerre',ico:'🔨',pid:'phys',addTree:'feu',passive:'Maître Forgeron — +dégâts & forge bonus',statBonus:{force:6,vigueur:2}},
      {key:'berserk_nain',n:'Berserker Runique',ico:'🪓',pid:'phys',addTree:'foudre',passive:'Rage Runique — dégâts explosifs sous 50% PV',statBonus:{force:6,vigueur:2,agilite:1}},
      {key:'avatar_forge',n:'Avatar de la Forge',ico:'🔥',pid:'phys',addTree:'feu',passive:'Incarnation du Feu — physique + feu fusionnés',statBonus:{force:8,esprit:3,vigueur:3}},
    ],
  },
  elfe:{
    A:[
      {key:'haut_elfe',n:'Haut-Elfe',ico:'🧝‍♀️',pid:'dodge',addTree:'lumiere',passive:'Grâce Ancienne — +esquive & lumière',statBonus:{agilite:4,esprit:3}},
      {key:'archimage_elfe',n:'Archimage Sylvain',ico:'🔮',pid:'mana',addTree:'givre',passive:'Magie Ancienne — +mana & sorts critiques',statBonus:{esprit:6,agilite:2}},
      {key:'avatar_elfe',n:'Avatar Éternel',ico:'✨',pid:'dodge',addTree:'lumiere',passive:'Essence Pure — invincible 1 tour/combat',statBonus:{esprit:6,agilite:6}},
    ],
    B:[
      {key:'traqueur_sylve',n:'Traqueur Sylvain',ico:'🏹',pid:'crit',addTree:'nature',passive:'Ombre des Bois — +critique & poison',statBonus:{agilite:5,chance:3}},
      {key:'assassin_elfe',n:'Assassin de la Nuit',ico:'🌑',pid:'crit',addTree:'tenebres',passive:'Lame Spectrale — critique devastateur',statBonus:{agilite:4,chance:4,esprit:1}},
      {key:'fantome_sylvain',n:'Fantôme Sylvain',ico:'👻',pid:'dodge',addTree:'tenebres',passive:'Mort Silencieuse — esquive + empoisonnement permanent',statBonus:{agilite:7,chance:5}},
    ],
  },
  mage:{
    A:[
      {key:'archimage',n:'Archimage',ico:'🌟',pid:'mana',addTree:'lumiere',passive:'Arcane Suprême — +mana & magie massive',statBonus:{esprit:6,chance:2}},
      {key:'mage_temps',n:'Mage du Temps',ico:'⏳',pid:'mana',addTree:'foudre',passive:'Distorsion Temporelle — tourne deux fois',statBonus:{esprit:5,agilite:3}},
      {key:'dieu_arcane',n:'Dieu Arcanique',ico:'🔱',pid:'mana',addTree:'givre',passive:'Omnimagie — tous les types élémentaux',statBonus:{esprit:10,chance:3}},
    ],
    B:[
      {key:'mage_guerre',n:'Mage de Guerre',ico:'⚔️',pid:'crit',addTree:'feu',passive:'Destruction Pure — sorts critiques x3',statBonus:{esprit:4,force:3,chance:2}},
      {key:'mage_ombre',n:'Mage des Ombres',ico:'🌑',pid:'crit',addTree:'tenebres',passive:'Sorcellerie Noire — tenebres & foudre décuplés',statBonus:{esprit:5,chance:3,vigueur:-1}},
      {key:'liche',n:'Liche Immortelle',ico:'💀',pid:'mana',addTree:'tenebres',passive:'Défi à la Mort — regagne vie par les sorts',statBonus:{esprit:8,vigueur:2}},
    ],
  },
  orque:{
    A:[
      {key:'uruk',n:'Uruk-Hai',ico:'👹',pid:'phys',addTree:'feu',passive:'Tueur-né — +dégâts physiques & feu',statBonus:{force:5,vigueur:3}},
      {key:'capitaine_uruk',n:'Capitaine Uruk',ico:'🗡️',pid:'phys',addTree:'tenebres',passive:'Commandant Brutal — attaque x2 parfois',statBonus:{force:5,vigueur:3,agilite:1}},
      {key:'seigneur_orque',n:'Seigneur des Orques',ico:'☠️',pid:'phys',addTree:'tenebres',passive:'Terreur Incarnée — ennemi recule 1 tour',statBonus:{force:8,vigueur:5}},
    ],
    B:[
      {key:'chaman_orque',n:'Chaman de Guerre',ico:'🔮',pid:'mana',addTree:'tenebres',passive:'Magie Sombre — sorts ténèbres puissants',statBonus:{esprit:5,vigueur:2}},
      {key:'prophete_orque',n:'Prophète Maudit',ico:'🩸',pid:'crit',addTree:'tenebres',passive:'Vision du Sang — critique fatal sous conditions',statBonus:{esprit:4,chance:4,vigueur:1}},
      {key:'dieu_guerre',n:'Dieu de la Guerre',ico:'💢',pid:'phys',addTree:'feu',passive:'Apocalypse Incarnée — attaque tous chaque tour',statBonus:{force:9,esprit:3,vigueur:3}},
    ],
  },
};

const BASE_RACE_KEYS=['humain','nain','elfe','mage','orque'];
// Paliers d'évolution
const EVO_PALIERS=[
  {tier:1, req:20, cost:30,  label:'Évolution I'},
  {tier:2, req:40, cost:80,  label:'Évolution II'},
  {tier:3, req:65, cost:200, label:'Forme Ultime'},
];

function addStats(base,d){ let nb={}; Object.keys(base).forEach(k=>nb[k]=base[k]+d); return nb; }
function addStatMap(base,map){ let nb=Object.assign({},base); for(let k in map)nb[k]=(nb[k]||0)+(map[k]||0); return nb; }
function withTree(trees,t){ let a=trees.slice(); if(t&&!a.includes(t))a.push(t); return a; }

// Génère toutes les formes évoluées à partir de EVOLUTION_TREE
(function buildEvoRaces(){
  Object.entries(EVOLUTION_TREE).forEach(([baseKey,branches])=>{
    let base=RACES[baseKey];
    ['A','B'].forEach(branchKey=>{
      let branch=branches[branchKey];
      branch.forEach((evo,idx)=>{
        let palier=idx+1; // 1,2,3
        let prevKey = idx===0 ? baseKey : branch[idx-1].key;
        let prevRace = RACES[prevKey];
        let newBase=addStatMap(addStats(prevRace.base, palier===3?5:3), evo.statBonus||{});
        let newTrees=withTree(prevRace.trees, evo.addTree);
        RACES[evo.key]={
          n:evo.n, ico:evo.ico,
          base:newBase,
          trees:newTrees,
          ...
          evoBranch:branchKey,
          evoTier:palier,
          nextEvoOptions: palier<3 ? [branch[idx+1].key] : null,
          // branches disponibles au palier 1 (depuis base)
        };
      });
    });
  });
...
function evoOptions(){
  let r=RACES[S.race];
  if(!r.evolved){
    // depuis une race de base : propose les 2 branches (palier 1)
    let bA=EVOLUTION_TREE[S.race]&&EVOLUTION_TREE[S.race].A[0];
    let bB=EVOLUTION_TREE[S.race]&&EVOLUTION_TREE[S.race].B[0];
    let opts=[bA,bB].filter(Boolean).map(e=>({key:e.key,n:RACES[e.key].n,ico:RACES[e.key].ico,passive:RACES[e.key].passive,pid:RACES[e.key].pid}));
    return {tier:1, req:EVO_PALIERS[0].req, cost:EVO_PALIERS[0].cost, opts};
  }
  let tier=r.evoTier||0;
  if(tier>=3)return {tier:0,opts:[]};
  // palier suivant : 2 options dans la même branche
  let baseKey=r.evoFrom;
  let branchKey=r.evoBranch;
  let branch=EVOLUTION_TREE[baseKey]&&EVOLUTION_TREE[baseKey][branchKey];
  if(!branch)return {tier:0,opts:[]};
  let next=branch[tier]; // tier = index du prochain (0-based)
  if(!next)return {tier:0,opts:[]};
  let palierInfo=EVO_PALIERS[tier]; // tier 1→idx1, tier2→idx2
  let opts=[{key:next.key,n:RACES[next.key].n,ico:RACES[next.key].ico,passive:RACES[next.key].passive,pid:RACES[next.key].pid}];
  // Si on est au palier 1, on peut aussi changer de branche encore (non, on reste sur la branche choisie)
  return {tier:tier+1, req:palierInfo.req, cost:palierInfo.cost, opts};
}
...
/* ===================================================================
   ARBRES DE COMPÉTENCES PAR RACE — profonds, 3 branches, 5 nœuds chacune
   Points gagnés : 1 tous les 10 niveaux (niv.10, 20, 30…)
   =================================================================== */
const RACE_SKILL_TREES={
  humain:[
    // Branche 1 : Combat
    {id:'h_atk1',n:'Frappe Martiale',branch:'⚔️ Combat',tier:1,max:3,eff:{atkPpct:0.06},desc:'+6% dégâts physiques / rang',req:[]},
    {id:'h_atk2',n:'Maîtrise des Armes',branch:'⚔️ Combat',tier:1,max:3,eff:{atkPpct:0.05,critFlat:0.02},desc:'+5% physique, +2% crit / rang',req:['h_atk1']},
    {id:'h_atk3',n:'Fureur du Soldat',branch:'⚔️ Combat',tier:2,max:3,eff:{atkPpct:0.08,lsFlat:0.02},desc:'+8% physique, +2% vol de vie / rang',req:['h_atk2']},
    {id:'h_atk4',n:'Percée Héroïque',branch:'⚔️ Combat',tier:3,max:2,eff:{atkPpct:0.12,critFlat:0.04},desc:'+12% physique, +4% crit / rang',req:['h_atk3']},
    {id:'h_atk5',n:'Légende des Batailles',branch:'⚔️ Combat',tier:4,max:1,eff:{atkPpct:0.25,critFlat:0.08,critDmgPct:0.30},desc:'★ +25% phys, +8% crit, +30% dégâts crit',req:['h_atk4'],cap:true},
    // Branche 2 : Lumière
    {id:'h_lum1',n:'Foi du Pèlerin',branch:'✨ Lumière',tier:1,max:3,eff:{healPct:0.06,hpPct:0.04},desc:'+6% soins, +4% PV / rang',req:[]},
    {id:'h_lum2',n:'Bénédiction Royale',branch:'✨ Lumière',tier:1,max:3,eff:{atkMpct:0.05,healPct:0.05},desc:'+5% mag, +5% soins / rang',req:['h_lum1']},
    {id:'h_lum3',n:'Aura Sacrée',branch:'✨ Lumière',tier:2,max:3,eff:{atkMpct:0.07,dodgeFlat:0.03},desc:'+7% mag, +3% esquive / rang',req:['h_lum2']},
    {id:'h_lum4',n:'Châtiment Céleste',branch:'✨ Lumière',tier:3,max:2,eff:{atkMpct:0.10,critFlat:0.05},desc:'+10% mag, +5% crit / rang',req:['h_lum3']},
    {id:'h_lum5',n:'Roi Sacré',branch:'✨ Lumière',tier:4,max:1,eff:{atkMpct:0.20,healPct:0.25,hpPct:0.15},desc:'★ +20% mag, +25% soins, +15% PV',req:['h_lum4'],cap:true},
    // Branche 3 : Adaptabilité
    {id:'h_ada1',n:'Polyvalence',branch:'🌀 Adaptabilité',tier:1,max:3,eff:{dropPct:0.08,goldPct:0.05},desc:'+8% butin, +5% or / rang',req:[]},
    {id:'h_ada2',n:'Instinct du Survivant',branch:'🌀 Adaptabilité',tier:1,max:3,eff:{hpPct:0.06,mitigFlat:0.02},desc:'+6% PV, +2% réduction / rang',req:['h_ada1']},
    {id:'h_ada3',n:'Sang Royal',branch:'🌀 Adaptabilité',tier:2,max:3,eff:{atkPpct:0.04,atkMpct:0.04,spdPct:0.04},desc:'+4% phys/mag/vitesse / rang',req:['h_ada2']},
    {id:'h_ada4',n:'Héritage Millénaire',branch:'🌀 Adaptabilité',tier:3,max:2,eff:{dropPct:0.12,critFlat:0.03,spdPct:0.06},desc:'+12% butin, +3% crit, +6% vitesse / rang',req:['h_ada3']},
    {id:'h_ada5',n:'Héros des Ages',branch:'🌀 Adaptabilité',tier:4,max:1,eff:{atkPpct:0.15,atkMpct:0.15,dropPct:0.20,hpPct:0.10},desc:'★ +15% phys/mag, +20% butin, +10% PV',req:['h_ada4'],cap:true},
  ],
  nain:[
    // Branche 1 : Roc
    {id:'n_roc1',n:'Peau de Pierre',branch:'🪨 Roc',tier:1,max:3,eff:{hpPct:0.08,mitigFlat:0.03},desc:'+8% PV, +3% réduction / rang',req:[]},
    {id:'n_roc2',n:'Forteresse Vivante',branch:'🪨 Roc',tier:1,max:3,eff:{hpPct:0.06,mitigFlat:0.03},desc:'+6% PV, +3% réduction / rang',req:['n_roc1']},
    {id:'n_roc3',n:'Cœur de Granit',branch:'🪨 Roc',tier:2,max:3,eff:{hpPct:0.08,mitigFlat:0.04},desc:'+8% PV, +4% réduction / rang',req:['n_roc2']},
    {id:'n_roc4',n:'Montagne Inébranlable',branch:'🪨 Roc',tier:3,max:2,eff:{hpPct:0.12,mitigFlat:0.05},desc:'+12% PV, +5% réduction / rang',req:['n_roc3']},
    {id:'n_roc5',n:'Titan de Pierre',branch:'🪨 Roc',tier:4,max:1,eff:{hpPct:0.30,mitigFlat:0.12},desc:'★ +30% PV, +12% réduction dégâts',req:['n_roc4'],cap:true},
    // Branche 2 : Forge
    {id:'n_forg1',n:'Art du Forgeron',branch:'🔨 Forge',tier:1,max:3,eff:{atkPpct:0.06},desc:'+6% dégâts physiques / rang',req:[]},
    {id:'n_forg2',n:'Marteau de Guerre',branch:'🔨 Forge',tier:1,max:3,eff:{atkPpct:0.07,lsFlat:0.02},desc:'+7% phys, +2% vol de vie / rang',req:['n_forg1']},
    {id:'n_forg3',n:'Acier Runique',branch:'🔨 Forge',tier:2,max:3,eff:{atkPpct:0.08,critFlat:0.03},desc:'+8% phys, +3% crit / rang',req:['n_forg2']},
    {id:'n_forg4',n:'Lame des Ancêtres',branch:'🔨 Forge',tier:3,max:2,eff:{atkPpct:0.12,critDmgPct:0.15},desc:'+12% phys, +15% dégâts crit / rang',req:['n_forg3']},
    {id:'n_forg5',n:'Maître Forgeron Légendaire',branch:'🔨 Forge',tier:4,max:1,eff:{atkPpct:0.28,critFlat:0.08,critDmgPct:0.35},desc:'★ +28% phys, +8% crit, +35% dégâts crit',req:['n_forg4'],cap:true},
    // Branche 3 : Rune
    {id:'n_run1',n:'Runes de Protection',branch:'⚡ Rune',tier:1,max:3,eff:{mitigFlat:0.03,hpPct:0.04},desc:'+3% réduction, +4% PV / rang',req:[]},
    {id:'n_run2',n:'Runes d\'Attaque',branch:'⚡ Rune',tier:1,max:3,eff:{atkPpct:0.05,critFlat:0.02},desc:'+5% phys, +2% crit / rang',req:['n_run1']},
    {id:'n_run3',n:'Inscription Ancestrale',branch:'⚡ Rune',tier:2,max:3,eff:{atkPpct:0.06,hpPct:0.06},desc:'+6% phys & PV / rang',req:['n_run2']},
    {id:'n_run4',n:'Rune du Berserk',branch:'⚡ Rune',tier:3,max:2,eff:{atkPpct:0.10,lsFlat:0.04,critFlat:0.04},desc:'+10% phys, +4% vol de vie & crit / rang',req:['n_run3']},
    {id:'n_run5',n:'Roi des Runes',branch:'⚡ Rune',tier:4,max:1,eff:{atkPpct:0.20,hpPct:0.20,critDmgPct:0.40},desc:'★ +20% phys & PV, +40% dégâts critiques',req:['n_run4'],cap:true},
  ],
  elfe:[
    // Branche 1 : Grâce
    {id:'e_gra1',n:'Pas Furtif',branch:'🌸 Grâce',tier:1,max:3,eff:{dodgeFlat:0.04,spdPct:0.04},desc:'+4% esquive & vitesse / rang',req:[]},
    {id:'e_gra2',n:'Danse du Vent',branch:'🌸 Grâce',tier:1,max:3,eff:{dodgeFlat:0.04,agilite:2},desc:'+4% esquive / rang',req:['e_gra1']},
    {id:'e_gra3',n:'Grâce Elfique',branch:'🌸 Grâce',tier:2,max:3,eff:{dodgeFlat:0.05,critFlat:0.03},desc:'+5% esquive, +3% crit / rang',req:['e_gra2']},
    {id:'e_gra4',n:'Fantôme Éternel',branch:'🌸 Grâce',tier:3,max:2,eff:{dodgeFlat:0.07,spdPct:0.08},desc:'+7% esquive, +8% vitesse / rang',req:['e_gra3']},
    {id:'e_gra5',n:'Intouchable',branch:'🌸 Grâce',tier:4,max:1,eff:{dodgeFlat:0.20,spdPct:0.20,critFlat:0.06},desc:'★ +20% esquive, +20% vitesse, +6% crit',req:['e_gra4'],cap:true},
    // Branche 2 : Magie
    {id:'e_mag1',n:'Channelage Elfique',branch:'🔮 Magie',tier:1,max:3,eff:{atkMpct:0.06,manaPct:0.05},desc:'+6% mag, +5% mana / rang',req:[]},
    {id:'e_mag2',n:'Maîtrise des Éléments',branch:'🔮 Magie',tier:1,max:3,eff:{atkMpct:0.07,critFlat:0.02},desc:'+7% mag, +2% crit / rang',req:['e_mag1']},
    {id:'e_mag3',n:'Arcane Sylvain',branch:'🔮 Magie',tier:2,max:3,eff:{atkMpct:0.08,manaPct:0.07},desc:'+8% mag, +7% mana / rang',req:['e_mag2']},
    {id:'e_mag4',n:'Invocation de l\'Aurore',branch:'🔮 Magie',tier:3,max:2,eff:{atkMpct:0.12,critFlat:0.04},desc:'+12% mag, +4% crit / rang',req:['e_mag3']},
    {id:'e_mag5',n:'Esprit Ancestral',branch:'🔮 Magie',tier:4,max:1,eff:{atkMpct:0.30,manaPct:0.25,critDmgPct:0.30},desc:'★ +30% mag, +25% mana, +30% dégâts crit',req:['e_mag4'],cap:true},
    // Branche 3 : Nature
    {id:'e_nat1',n:'Communion Sylvestre',branch:'🌿 Nature',tier:1,max:3,eff:{healPct:0.07,dropPct:0.05},desc:'+7% soins, +5% butin / rang',req:[]},
    {id:'e_nat2',n:'Venin de la Forêt',branch:'🌿 Nature',tier:1,max:3,eff:{atkMpct:0.05,critFlat:0.03},desc:'+5% mag, +3% crit / rang',req:['e_nat1']},
    {id:'e_nat3',n:'Régénération Naturelle',branch:'🌿 Nature',tier:2,max:3,eff:{healPct:0.08,hpPct:0.06},desc:'+8% soins, +6% PV / rang',req:['e_nat2']},
    {id:'e_nat4',n:'Esprit de la Forêt',branch:'🌿 Nature',tier:3,max:2,eff:{atkMpct:0.08,healPct:0.10},desc:'+8% mag, +10% soins / rang',req:['e_nat3']},
    {id:'e_nat5',n:'Gardien de l\'Éternité',branch:'🌿 Nature',tier:4,max:1,eff:{healPct:0.30,atkMpct:0.18,manaPct:0.20},desc:'★ +30% soins, +18% mag, +20% mana',req:['e_nat4'],cap:true},
  ],
  mage:[
    // Branche 1 : Destruction
    {id:'m_des1',n:'Feu Arcanique',branch:'💥 Destruction',tier:1,max:3,eff:{atkMpct:0.07},desc:'+7% dégâts magiques / rang',req:[]},
    {id:'m_des2',n:'Surcharge',branch:'💥 Destruction',tier:1,max:3,eff:{atkMpct:0.07,critFlat:0.03},desc:'+7% mag, +3% crit / rang',req:['m_des1']},
    {id:'m_des3',n:'Tempête Élémentale',branch:'💥 Destruction',tier:2,max:3,eff:{atkMpct:0.09,critDmgPct:0.12},desc:'+9% mag, +12% dégâts crit / rang',req:['m_des2']},
    {id:'m_des4',n:'Nova du Chaos',branch:'💥 Destruction',tier:3,max:2,eff:{atkMpct:0.12,critFlat:0.05},desc:'+12% mag, +5% crit / rang',req:['m_des3']},
    {id:'m_des5',n:'Singularité Arcanique',branch:'💥 Destruction',tier:4,max:1,eff:{atkMpct:0.35,critFlat:0.10,critDmgPct:0.50},desc:'★ +35% mag, +10% crit, +50% dégâts crit',req:['m_des4'],cap:true},
    // Branche 2 : Mana
    {id:'m_man1',n:'Réservoir Profond',branch:'💧 Mana',tier:1,max:3,eff:{manaPct:0.08},desc:'+8% mana max / rang',req:[]},
    {id:'m_man2',n:'Flux Arcanique',branch:'💧 Mana',tier:1,max:3,eff:{manaPct:0.07,atkMpct:0.05},desc:'+7% mana, +5% mag / rang',req:['m_man1']},
    {id:'m_man3',n:'Maîtrise Runique',branch:'💧 Mana',tier:2,max:3,eff:{manaPct:0.08,atkMpct:0.06},desc:'+8% mana, +6% mag / rang',req:['m_man2']},
    {id:'m_man4',n:'Source Inépuisable',branch:'💧 Mana',tier:3,max:2,eff:{manaPct:0.12,atkMpct:0.08},desc:'+12% mana, +8% mag / rang',req:['m_man3']},
    {id:'m_man5',n:'Dieu du Mana',branch:'💧 Mana',tier:4,max:1,eff:{manaPct:0.35,atkMpct:0.20,critFlat:0.08},desc:'★ +35% mana, +20% mag, +8% crit',req:['m_man4'],cap:true},
    // Branche 3 : Métamagie
    {id:'m_meta1',n:'Amplification',branch:'🌀 Métamagie',tier:1,max:3,eff:{atkMpct:0.05,manaPct:0.05},desc:'+5% mag & mana / rang',req:[]},
    {id:'m_meta2',n:'Instabilité Magique',branch:'🌀 Métamagie',tier:1,max:3,eff:{critFlat:0.04,critDmgPct:0.10},desc:'+4% crit, +10% dégâts crit / rang',req:['m_meta1']},
    {id:'m_meta3',n:'Résonnance Élémentale',branch:'🌀 Métamagie',tier:2,max:3,eff:{atkMpct:0.07,critDmgPct:0.12},desc:'+7% mag, +12% dégâts crit / rang',req:['m_meta2']},
    {id:'m_meta4',n:'Transcendance',branch:'🌀 Métamagie',tier:3,max:2,eff:{atkMpct:0.10,manaPct:0.10,spdPct:0.06},desc:'+10% mag/mana, +6% vitesse / rang',req:['m_meta3']},
    {id:'m_meta5',n:'Archimage Absolu',branch:'🌀 Métamagie',tier:4,max:1,eff:{atkMpct:0.25,manaPct:0.25,critDmgPct:0.45},desc:'★ +25% mag/mana, +45% dégâts critiques',req:['m_meta4'],cap:true},
  ],
  orque:[
    // Branche 1 : Brutalité
    {id:'o_bru1',n:'Sauvagerie',branch:'💢 Brutalité',tier:1,max:3,eff:{atkPpct:0.08},desc:'+8% dégâts physiques / rang',req:[]},
    {id:'o_bru2',n:'Rage de Bataille',branch:'💢 Brutalité',tier:1,max:3,eff:{atkPpct:0.08,lsFlat:0.02},desc:'+8% phys, +2% vol de vie / rang',req:['o_bru1']},
    {id:'o_bru3',n:'Carnage',branch:'💢 Brutalité',tier:2,max:3,eff:{atkPpct:0.10,critFlat:0.03},desc:'+10% phys, +3% crit / rang',req:['o_bru2']},
    {id:'o_bru4',n:'Fureur du Sang',branch:'💢 Brutalité',tier:3,max:2,eff:{atkPpct:0.14,lsFlat:0.05},desc:'+14% phys, +5% vol de vie / rang',req:['o_bru3']},
    {id:'o_bru5',n:'Incarnation de la Guerre',branch:'💢 Brutalité',tier:4,max:1,eff:{atkPpct:0.35,critFlat:0.10,critDmgPct:0.40},desc:'★ +35% phys, +10% crit, +40% dégâts crit',req:['o_bru4'],cap:true},
    // Branche 2 : Ténèbres
    {id:'o_ten1',n:'Connexion à l\'Ombre',branch:'🌑 Ténèbres',tier:1,max:3,eff:{atkMpct:0.06,atkPpct:0.04},desc:'+6% mag ténèbres, +4% phys / rang',req:[]},
    {id:'o_ten2',n:'Maléfice',branch:'🌑 Ténèbres',tier:1,max:3,eff:{atkMpct:0.07,critFlat:0.03},desc:'+7% mag, +3% crit / rang',req:['o_ten1']},
    {id:'o_ten3',n:'Damnation',branch:'🌑 Ténèbres',tier:2,max:3,eff:{atkMpct:0.08,lsFlat:0.03},desc:'+8% mag, +3% vol de vie / rang',req:['o_ten2']},
    {id:'o_ten4',n:'Emprise Ténébreuse',branch:'🌑 Ténèbres',tier:3,max:2,eff:{atkMpct:0.12,critDmgPct:0.18},desc:'+12% mag, +18% dégâts crit / rang',req:['o_ten3']},
    {id:'o_ten5',n:'Seigneur de l\'Ombre',branch:'🌑 Ténèbres',tier:4,max:1,eff:{atkMpct:0.25,atkPpct:0.15,critDmgPct:0.45},desc:'★ +25% mag, +15% phys, +45% dégâts crit',req:['o_ten4'],cap:true},
    // Branche 3 : Survie
    {id:'o_sur1',n:'Chair d\'Orque',branch:'🩸 Survie',tier:1,max:3,eff:{hpPct:0.07,mitigFlat:0.02},desc:'+7% PV, +2% réduction / rang',req:[]},
    {id:'o_sur2',n:'Régénération Bestiale',branch:'🩸 Survie',tier:1,max:3,eff:{hpPct:0.06,lsFlat:0.03},desc:'+6% PV, +3% vol de vie / rang',req:['o_sur1']},
    {id:'o_sur3',n:'Instinct Primaire',branch:'🩸 Survie',tier:2,max:3,eff:{hpPct:0.08,atkPpct:0.05},desc:'+8% PV, +5% phys / rang',req:['o_sur2']},
    {id:'o_sur4',n:'Rage du Mourant',branch:'🩸 Survie',tier:3,max:2,eff:{atkPpct:0.15,hpPct:0.08},desc:'+15% phys, +8% PV / rang — décuplés sous 30% PV',req:['o_sur3']},
    {id:'o_sur5',n:'Bête Immortelle',branch:'🩸 Survie',tier:4,max:1,eff:{hpPct:0.25,atkPpct:0.18,lsFlat:0.08},desc:'★ +25% PV, +18% phys, +8% vol de vie',req:['o_sur4'],cap:true},
  ],
};
...
function raceTreeFor(raceKey){
  ...
  if(RACE_SKILL_TREES[base]){ _raceTreeCache[base]=RACE_SKILL_TREES[base]; return _raceTreeCache[base]; }
  // fallback générique
  let pid=(RACES[base]&&RACES[base].pid)||'xp';
  let tree=[
    {id:base+'_atk1',n:'Attaque',branch:'⚔️ Combat',tier:1,max:3,eff:{atkPpct:0.05,atkMpct:0.05},desc:'+5% dégâts / rang',req:[]},
    {id:base+'_def1',n:'Défense',branch:'🛡️ Défense',tier:1,max:3,eff:{hpPct:0.06},desc:'+6% PV / rang',req:[]},
    {id:base+'_cap', n:'Maîtrise Suprême',branch:'⭐ Apothéose',tier:4,max:1,eff:{atkPpct:0.20,atkMpct:0.20,hpPct:0.15},desc:'★ Puissance ultime',req:[base+'_atk1',base+'_def1'],cap:true},
  ];
...
const TIER_LEVEL_REQ={1:1, 2:20, 3:40, 4:65};
...
window.cmdRing=function(){ if(!canAct())return; let m=B.curMember; if(!m.isHero){ toast('Seul le Porteur peut user de l\'Anneau.'); return; }
  ...
  if(!S.isNazgul){ addCorruption(1.5); } // Anneau corrompt lentement
...
function doMove(actor,t,target){
  ...
  if(t.kind==='heal'){
    ...
    sfx('debuff');
    if(actor.isHero&&!S.isNazgul&&techTypes(t).includes('tenebres')) addCorruption(0.3);
  } else { // attack
    ...
    // corruption : les Ténèbres rongent lentement (progression très lente)
    if(actor.isHero&&!S.isNazgul&&techTypes(t).includes('tenebres')){ addCorruption(t.target==='all'?0.5:0.35); }
  }
...
function grantRewards(zone,boss,opt){
  ...
  // niveaux héros
  S.xp+=xp; let gained=0; while(S.xp>=xpNeeded(S.level)){ S.xp-=xpNeeded(S.level); S.level++; S.statPoints+=3;
    if(S.level%10===0){ S.talentPoints=(S.talentPoints||0)+1; } // 1 point de compétence tous les 10 niveaux
    gained++; }
  // niveaux alliés
  let allyMsgs=[];
...
function renderHeroScreen(){
  ...
  // ÉVOLUTION DE RACE (chemin complet 3 paliers)
  let ev=evoOptions();
  let raceEvoFrom=RACES[S.race].evoFrom||S.race;
  let raceTier=RACES[S.race].evoTier||0;
  // Affiche le chemin d'évolution choisi
  if(race.evolved){
    let branchLabel=race.evoBranch==='A'?'Voie A':'Voie B';
    html+=`<div class="card" style="border:1px solid rgba(230,167,62,.3);padding:12px">
      <div class="cz" style="font-size:12px;color:var(--ember-bright);margin-bottom:6px">🌳 Voie d'Évolution — Palier ${raceTier}/3</div>
      <div class="evo-path">${[1,2,3].map(p=>{
        let branch=EVOLUTION_TREE[raceEvoFrom]&&EVOLUTION_TREE[raceEvoFrom][race.evoBranch];
        let e=branch&&branch[p-1];
        let active=p<=raceTier; let current=p===raceTier;
        return e?`<div class="evo-step ${active?'active':''} ${current?'current':''}">
          <span class="evo-step-ico">${active?e.ico:'🔒'}</span>
          <span class="evo-step-name">${e.n}</span>
          <span class="evo-step-lvl">niv.${EVO_PALIERS[p-1].req}</span>
        </div>`:'';
      }).join('<div class="evo-step-arrow">→</div>')}</div>
    </div>`;
  }
  if(ev.tier===0){
    html+=`<div class="card" style="border:1px solid var(--ember)"><div class="cz" style="font-size:13px;color:var(--ember-bright)">🌟 Forme Ultime Atteinte</div>
      <div class="sub" style="font-size:11px;margin-top:4px">${race.ico} ${race.n} — tu as atteint le sommet absolu de ta lignée.</div></div>`;
  } else {
    let ok=S.level>=ev.req && S.ess>=ev.cost;
    let tierLabel=['','⭐ Première Évolution','✨ Ascension','🌟 Forme Ultime'][ev.tier]||'Évolution';
    html+=`<div class="card" style="border:1px solid var(--line2)">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
        <span class="cz" style="font-size:13px;color:var(--ember-bright)">${tierLabel}</span>
        <span style="font-size:10.5px;color:${ok?'var(--ember-bright)':'var(--blood)'}">niv.${ev.req} · 💎${ev.cost}</span>
      </div>
      <div class="sub" style="font-size:11px;margin-bottom:8px">
        ${ev.tier===1?'Choisis ta voie de spécialisation. Ce choix est définitif pour ce palier.':
          ev.tier===2?'Ta voie continue. Puissance accrue et nouveaux arbres élémentaux.':
          'La forme ultime. Au-delà de toute limite.'}
      </div>`;
    ev.opts.forEach(opt=>{
      html+=`<div class="evo-opt">
        <div style="font-size:28px;margin-right:4px">${opt.ico}</div>
        <div class="evo-mid"><div class="evo-n">${opt.n}</div><div class="evo-d">${opt.passive}</div></div>
  ...
  // ===== ARBRE DE COMPÉTENCES (par race, 3 branches profondes) =====
  let baseRaceKey=RACES[S.race].evoFrom||S.race;
  let baseRaceName=RACES[baseRaceKey].n;
  let nextTpLevel=S.level%10===0?'prochain: '+(S.level+10):`prochain: niv.${Math.ceil(S.level/10)*10}`;
  html+=`<div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px">
      <span class="cz" style="font-size:14px;color:var(--ember-bright)">🌳 Arbre de ${baseRaceName}</span>
      <div style="text-align:right"><span style="font-size:13px;color:var(--ember-bright);font-family:Cinzel;font-weight:700">${S.talentPoints||0} pt${(S.talentPoints||0)>1?'s':''}</span>
      <div style="font-size:9.5px;color:var(--faint)">${nextTpLevel}</div></div>
    </div>`;
  let tree=allTalentNodes();
  // Grouper par branche
  let branches=[...new Set(tree.map(n=>n.branch))];
  branches.forEach(branchLabel=>{
    let nodes=tree.filter(n=>n.branch===branchLabel).sort((a,b)=>a.tier-b.tier);
    html+=`<div class="skill-branch"><div class="skill-branch-title">${branchLabel}</div><div class="skill-chain">`;
    nodes.forEach((t,ni)=>{
      let r=talentRank(t.id); let maxed=r>=t.max;
      let lvReq=TIER_LEVEL_REQ[t.tier]||1;
      let lvlOk=S.level>=lvReq; let prereq=skillPrereqOk(t);
      let can=!maxed&&lvlOk&&prereq&&(S.talentPoints||0)>0;
      let locked=!lvlOk||!prereq;
      if(ni>0)html+=`<div class="skill-arrow">▼</div>`;
      html+=`<div class="skill-node ${r>0?'on':''} ${locked?'locked':''} ${t.cap?'cap':''}">
        <div class="sk-mid">
          <div class="sk-n">${t.cap?'★ ':''}${t.n} <span class="sk-rank">${r}/${t.max}</span></div>
          <div class="sk-d">${t.desc}</div>
          <div class="sk-req">${!lvlOk?`🔒 niv. ${lvReq} requis`:!prereq?'⛔ prérequis manquant':maxed?'✓ Maîtrisé':''}</div>
        </div>
  ...
  html+=`<button class="btn sm ghost block" style="margin-top:10px" onclick="resetTalents()">↺ Réinitialiser (rend les points)</button></div>`;
  // Anneau & corruption
  html+=`<div class="card ring-card">
    ...
    <div class="sub" style="font-size:11px;margin-bottom:8px">Tu portes l'Anneau depuis le départ. En combat, son <b>Pouvoir</b> déchaîne les ténèbres — chaque usage corrompt légèrement.${S.ringUses?` (utilisé ${S.ringUses} fois)`:''}</div>
    <div class="cz" style="font-size:12px;color:var(--arcane-bright);margin-bottom:6px">🌑 Corruption ${S.corruption.toFixed(1)}%</div>
    ...
    <div class="sub" style="font-size:10.5px;margin-top:5px;color:var(--faint)">${S.isNazgul?'Tu as succombé à l\'Ombre. Tu es désormais un Nazgûl.':'La corruption monte lentement. À 100% tu deviens Nazgûl. Purification : -25% pour 10 essence.'}</div>
    ${S.isNazgul?'':`<button class="btn sm ghost block" style="margin-top:8px" onclick="purify()">✨ Purifier (-25% corruption, 10 💎)</button>`}
  </div>`;
  // options audio
...
window.learnTalent=function(id){ if((S.talentPoints||0)<=0){toast('Aucun point de compétence.');return;}
  ...
  let lvReq=TIER_LEVEL_REQ[node.tier]||1;
  if(S.level<lvReq){toast(`Niveau ${lvReq} requis (Tier ${node.tier}).`);return;}
...
window.purify=function(){ if(S.ess<10){toast('Pas assez d\'essence (10 requis).');return;} S.ess-=10; S.corruption=Math.max(0,S.corruption-25); sfx('heal'); renderHeroScreen(); renderTop(); save(); };
window.evolveRace=function(toKey){
  ...
  let tierLabel=['','Première Évolution','Ascension','Forme Ultime'][RACES[toKey].evoTier||1]||'Évolution';
  sfx('evolve'); flash('#e6a73e',.5); toast(`🌟 ${tierLabel} ! Tu deviens ${RACES[S.race].ico} ${RACES[S.race].n} !`);
...
/* corruption gain quand on lance une tech ténèbres (héros) — très lente à monter */
    ...
    <div style="width:100%;max-width:380px;margin-top:10px">
      ...
      <div class="choice-grid" id="raceGrid">
        ${BASE_RACE_KEYS.map(k=>[k,RACES[k]]).map(([k,r])=>`<div class="choice ${mkRace===k?'sel':''}" data-race="${k}">
          ...
          <div class="cdesc">${r.passive}<br><span style="color:var(--spectral)">${r.trees.map(tt=>TYPES[tt].ico).join(' ')}</span></div>
          <div class="cevo">⭐ niv.20 · ✨ niv.40 · 🌟 niv.65</div></div>`).join('')}
      </div>
